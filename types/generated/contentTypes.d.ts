...
export interface ApiFooterFooter extends Schema.CollectionType {
  ...
  attributes: {
    contentValue: Attribute.String & Attribute.Required;
    URL_Route: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiNuclearmedicinepagefirstsectionNuclearmedicinepagefirstsection
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::nuclearmedicinepagefirstsection.nuclearmedicinepagefirstsection',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProductdetailProductdetail extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ProductdetailMainheading: Attribute.Media & Attribute.Required;
    interiorFirstHeading: Attribute.String & Attribute.Required;
    interiorFirstDes: Attribute.Text & Attribute.Required;
    interiorSecondHeading: Attribute.String & Attribute.Required;
    interiorSecondDes: Attribute.Text & Attribute.Required;
    interiorThirdHeading: Attribute.String & Attribute.Required;
    interiorThirdDes: Attribute.Text & Attribute.Required;
    interiorMainHeading: Attribute.String & Attribute.Required;
...
export interface ApiSurgicalImagingSurgicalImaging
  extends Schema.CollectionType {
  collectionName: 'surgical_imagings';
  info: {
    singularName: 'surgical-imaging';
    pluralName: 'surgical-imagings';
    displayName: 'Surgical Imaging';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    Description: Attribute.Text;
    freetrailbtn: Attribute.String & Attribute.Required;
    orderbtn: Attribute.String & Attribute.Required;
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::surgical-imaging.surgical-imaging',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
